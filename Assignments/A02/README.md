...
- Create a repository named:
    - `4143-PLC` 
    - If the it won't let you use the above repo name with the section, then add your name at the end to make it unique (like `4143-PLC-Gumby` ).
...
|                           **Markdown Output**                           |
| :---------------------------------------------------------------------: |
| <img src="https://images2.imgbox.com/c8/14/mZjdjhIK_o.png" width="500"> |
...
<img src="https://images2.imgbox.com/b7/e0/4sP4NGdn_o.png?download=true" width="600">
